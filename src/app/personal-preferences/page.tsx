...
export default function PersonalPreferencesPage() {
    ...
    return (
      <main className="min-h-screen bg-[#0A0B1A] text-white flex flex-col items-center justify-center py-8 px-4 font-sans">
        <div className="flex items-center justify-center py-6">
          ...
          <p className="ml-4 text-gray-300 text-xl">Loading your personal preferences...</p>
        </div>
      </main>
    );
  }
  ...
  if (error) {
    return (
      <main className="min-h-screen bg-[#0A0B1A] text-white flex flex-col items-center justify-center py-8 px-4 font-sans">
        <div className="text-center p-8 bg-red-800 rounded-lg border border-red-600">
          <h2 className="text-2xl font-bold text-red-100 mb-4">Error Loading Preferences</h2>
  ...
  return (
    <main className="min-h-screen bg-[#0A0B1A] text-white flex flex-col items-center py-8 px-4 font-sans">
      <header className="w-full max-w-3xl flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-white">Personal Preferences</h1>
      </header>
